...
The frontend side of the application is written in [React](https://reactjs.org/), which gives developer necessary tools to build web applications in functional and declarative way. In addition, I installed various React packages to achieve crucial goals like routing between pages, dragging and dropping list items to re-order personal playlist tracks, and UI themed components. I went with one of the most popular UI themed components out there, the [Material UI library](https://material-ui.com/). Material UI helped me focus more on functionality rather than spending time writing custom CSS. It significantly reduced total development time. You can check out the [most popular React UI libraries out there](https://blog.logrocket.com/top-10-react-component-libraries-for-2020/).
